import{_ as s,o as n,c as a,e as i}from"./app-65608fb9.js";const e={},l=i(`<h1 id="linux使用ssh连接github" tabindex="-1"><a class="header-anchor" href="#linux使用ssh连接github" aria-hidden="true">#</a> linux使用ssh连接github</h1><ol><li>切换路径到 .ssh</li><li>使用 ssh 生成密钥</li><li>新建一个 config 文件</li><li>打开 ssh 代理</li><li>添加新的密钥到 ssh 代理</li><li>添加密钥到 github</li><li>测试 github 连接</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 1. 切换路径到 .ssh</span>
