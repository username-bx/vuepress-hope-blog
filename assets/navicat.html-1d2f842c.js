import{_ as n,o as s,c as a,e}from"./app-c26bd9fc.js";const i={},t=e(`<h1 id="navicat-重置试用期-图形化数据库管理及发展软件" tabindex="-1"><a class="header-anchor" href="#navicat-重置试用期-图形化数据库管理及发展软件" aria-hidden="true">#</a> Navicat 重置试用期 图形化数据库管理及发展软件</h1><p>记录下来,自用.</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>
