import{_ as n,o as s,c as a,b as p}from"./app-00ed1d93.js";const t={},e=p(`<h1 id="jsx" tabindex="-1"><a class="header-anchor" href="#jsx" aria-hidden="true">#</a> jsx</h1><h2 id="_1-jsx" tabindex="-1"><a class="header-anchor" href="#_1-jsx" aria-hidden="true">#</a> 1. jsx</h2><ol><li><p>jsx 本质是一个对象, 是一个 React.createElement 生成的对象.</p></li><li><p>表达式 需要加 ()</p></li><li><p>只有一个根节点</p></li><li><p>&lt;&gt;&lt;/&gt; 语法糖</p></li></ol><h2 id="_2-在-jsx-中写表达式" tabindex="-1"><a class="header-anchor" href="#_2-在-jsx-中写表达式" aria-hidden="true">#</a> 2. 在 jsx 中写表达式</h2><h3 id="_1-将表达式作为内容的一部分" tabindex="-1"><a class="header-anchor" href="#_1-将表达式作为内容的一部分" aria-hidden="true">#</a> 1. 将表达式作为内容的一部分</h3><ol><li>普通表达式</li></ol><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>
