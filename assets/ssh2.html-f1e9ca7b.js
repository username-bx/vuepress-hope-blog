import{_ as s,o as e,c as i,f as a}from"./app-131752ea.js";const n={},l=a(`<h1 id="使用ssh同时连接gitlab-github" tabindex="-1"><a class="header-anchor" href="#使用ssh同时连接gitlab-github" aria-hidden="true">#</a> 使用ssh同时连接gitlab github</h1><ol><li><p>打开文件夹 c:/user/xxx/.ssh</p></li><li><p>右键 git bash here</p></li><li><p>生成ssh</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ ssh-keygen <span class="token parameter variable">-t</span> ed25519 <span class="token parameter variable">-C</span> <span class="token string">&quot;bx.ma@gmail.com&quot;</span>
// 输入名称 id_ssh_gitlab
